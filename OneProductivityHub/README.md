...
- Part 2 - Add Microsoft Graph Toolkit and build the auth pop-up page
- Part 3 - Build One Productivity Hub using Microsoft Graph Toolkit components
- Part 4 - Register your application in Azure Active Directory
